...
nuodb-cp database list [-hV] [-b=<urlBase>] [-u=<user>] [-p[=<password>]]
                       [--trusted-cert=<trustedCert>] [-f=<labelFilter>]...
...
nuodb-cp database create [-hV] [-b=<urlBase>] [-u=<user>] [-p[=<password>]]
                         ...
                         [--tier-param=<String=String>]... DATABASE
....
